# Copyright (c) 2017, Romain Bailly
#
...
GTEST_FILTER  ?= *
CMAKE_OPTIONS := "-DRMGR_SSIM_BUILD_TESTS=ON"
...
CMAKE_OPTIONS += $(if $(CMAKE_TOOLCHAIN_FILE),"-DCMAKE_TOOLCHAIN_FILE=$(CMAKE_TOOLCHAIN_FILE)",)
CMAKE_OPTIONS += "-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=$(CMAKE_ARCHIVE_OUTPUT_DIRECTORY)"
CMAKE_OPTIONS += "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=$(CMAKE_LIBRARY_OUTPUT_DIRECTORY)"
CMAKE_OPTIONS += "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=$(CMAKE_RUNTIME_OUTPUT_DIRECTORY)"
