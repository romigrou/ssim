...
GTEST_FILTER  ?= *
CMAKE_OPTIONS := "-DRMGR_SSIM_BUILD_CLI=$(DRMGR_SSIM_BUILD_CLI)" "-DRMGR_SSIM_BUILD_SAMPLE=$(DRMGR_SSIM_BUILD_SAMPLE)" "-DRMGR_SSIM_BUILD_TESTS=$(RMGR_SSIM_BUILD_TESTS)" "-DRMGR_SSIM_USE_OPENMP=$(RMGR_SSIM_USE_OPENMP)" "-DRMGR_SSIM_USE_DOUBLE=$(RMGR_SSIM_USE_DOUBLE)"

SOURCE_DIR    := $(HERE)
CMAKE_TARGETS := rmgr-ssim-tests rmgr-ssim install package
