...
set CMAKE_OPTIONS=%CMAKE_OPTIONS% "-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=%LIB_DIR%\%QUADRUPLET%"
set CMAKE_OPTIONS=%CMAKE_OPTIONS% "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=%BIN_DIR%\%QUADRUPLET%"
set CMAKE_OPTIONS=%CMAKE_OPTIONS% "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=%BIN_DIR%\%QUADRUPLET%"
set CMAKE_OPTIONS=%CMAKE_OPTIONS% "-DCMAKE_INSTALL_PREFIX=%PKG_DIR%\%TRIPLET%"
set CMAKE_OPTIONS=%CMAKE_OPTIONS% "-DCPACK_PACKAGE_DIRECTORY=%PKG_DIR%"
set CMAKE_OPTIONS=%CMAKE_OPTIONS% "-DCPACK_SYSTEM_NAME=%TRIPLET%"
